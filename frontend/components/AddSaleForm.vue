        ...
        <div class="modal-card">
            ...
            <section class="modal-card-body">
                <b-field label="Вариант продукта">
                    <b-select v-model="formData.variant_id" type="text" placeholder="Выберите вариант продукта" required>
                ...
                <b-field label="Введите колличество">
                    <b-input v-model="formData.quantity" type="text" placeholder="Введите колличество" required></b-input>
                </b-field>
            </section>
