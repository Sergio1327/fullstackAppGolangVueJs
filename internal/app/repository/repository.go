...
// AddProduct - вставки названия,описания,времени добавления и тегов в базу
...
// LoadProductInfo - Получени информации о продукте
...
// LoadStocks - Получение информации о складах
